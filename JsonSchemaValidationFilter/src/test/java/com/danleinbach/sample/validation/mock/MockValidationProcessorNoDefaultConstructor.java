 ...
 * @author Daniel
 */
public class MockValidationProcessorNoDefaultConstructor implements IJsonSchemaValidationProcessor {

	private static final Logger LOGGER = LoggerFactory.getLogger(MockValidationProcessorNoDefaultConstructor.class);

	public MockValidationProcessorNoDefaultConstructor(String test) {
	}
